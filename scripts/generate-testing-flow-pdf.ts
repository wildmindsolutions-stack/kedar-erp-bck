/**
 * Generates Kedar_ERP_Testing_Flow.pdf in the project docs folder.
 * Run: cd backend && npx ts-node scripts/generate-testing-flow-pdf.ts
 */
...
h2('Role Checklist');
table(
  ['Role', 'Must Work', 'Must Be Blocked'],
  [
...
doc.fontSize(8).fillColor(muted).text(
  'WildMind Solutions · Kedar Enterprise ERP · Confidential',
  { align: 'center' },
);
